...
<body>
    ...
    if (userProducts === [] || userProducts.length === 0) {
      ...
      for (let i = 0; i < cart_list.length; i++) {
        ...
        button.setAttribute("data-productId", cart_list[i].id);
      ...
      removeFood.forEach(function removeItem(removeId) {
          ...
          const productId = parseInt(this.dataset.productId); //Getting product id from the button
      ...
      plus.forEach(function addQuantity(find_quantity) {
        find_quantity.addEventListener("click", function () {
          ...
          const cart_quantity = userProducts.find(find_cart);
          if (cart_quantity) {
      ...
      selected_time.forEach(function selectTime(find_time) {
        find_time.addEventListener("click", function () {
          ...
          const ordered_time = userProducts.find(find_cart);
          if (ordered_time) {
